...
st.write('This is a web app to predict your 90-day functional outcome based on several features. Please click on the link to download the form and fill in the corresponding data. After that, click on the Predict button at the bottom to see the prediction of the classifier.This app can predict the prognosis of multiple patients multiple patients at one time. ')
