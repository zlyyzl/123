...
def prediction_page():
    ...
    if page == "Home Page":
        ...
        prediction_type = st.sidebar.selectbox(
            ...
            ("Preoperative_number", "Preoperative_batch", "Perioperative_number", "Perioperative_batch", 
        ...
        elif prediction_type == "Perioperative_number":
            st.subheader("Perioperative Number Prediction")
            st.write("This section will handle perioperative number predictions.please fill in the blanks with corresponding data. After that,click on the Predict button at the bottom to see the prediction of the classifier.")
        ...
        elif prediction_type == "Perioperative_batch":
            st.subheader("Perioperative Batch Prediction")
            st.write("This section will handle perioperative batch predictions.Please click on the link to download the form and fill in the corresponding data. After that, click on the Browse files button to upload file for prediciton, you can see the prediction of the classifier at the bottom. This page supports batch prediction of the outcome of multiple patients at one time, and can predict the outcome of patients with missing values.")
            def plot_roc_curve(y_true, y_scores): 
                fpr, tpr, thresholds = roc_curve(y_true, y_scores) 
                roc_auc = auc(fpr, tpr)
