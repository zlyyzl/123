...
def prediction_page():
    ...
    if page == "Home Page":
        ...
        pdf_file_path = r"User Manual1.pdf"
...
def main():
    # Set page config once at the beginning - THIS IS THE CORRECT PLACE
    st.set_page_config(page_title="Functional Outcome Prediction", layout="centered") 
    
    # Directly call the main application page function
    prediction_page()
